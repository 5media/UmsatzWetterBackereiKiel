...
# Summieren Sie den Umsatz für das Geschäftsjahr 2014/15
umsatz_2014_15 = df_sum.loc[df_sum['Geschaeftsjahr'] == '2014/15', 'Umsatz'].sum()

# Ausgeben der Summe des Umsatzes für das Geschäftsjahr 2014/15
print("Umsatz14/15:", umsatz_2014_15)

# Summieren Sie den Umsatz für das Geschäftsjahr 2015/16
umsatz_2015_16 = df_sum.loc[df_sum['Geschaeftsjahr'] == '2015/16', 'Umsatz'].sum()

# Ausgeben der Summe des Umsatzes für das Geschäftsjahr 2015/16
print("Umsatz15/16:", umsatz_2015_16)

# Summieren Sie den Umsatz für das Geschäftsjahr 2016/17
umsatz_2016_17 = df_sum.loc[df_sum['Geschaeftsjahr'] == '2016/17', 'Umsatz'].sum()

# Ausgeben der Summe des Umsatzes für das Geschäftsjahr 2016/17
print("Umsatz16/17:", umsatz_2016_17)

# Summieren Sie den Umsatz für das Geschäftsjahr 2017/18
umsatz_2017_18 = df_sum.loc[df_sum['Geschaeftsjahr'] == '2017/18', 'Umsatz'].sum()

# Ausgeben der Summe des Umsatzes für das Geschäftsjahr 2017/18
print("Umsatz17/18:", umsatz_2017_18)


import statsmodels.api as sm
import pandas as pd

# Konvertieren Sie die Geschäftsjahre in numerische Werte
df_sum['Geschaeftsjahr_num'] = df_sum['Geschaeftsjahr'].str[:4].astype(int)

# Definieren Sie Ihre abhängige Variable
Y = df_sum['Umsatz']

# Definieren Sie Ihre unabhängige Variable. Fügen Sie eine Konstante hinzu, um einen Y-Achsenabschnitt zu haben.
X = sm.add_constant(df_sum['Geschaeftsjahr_num'])

# Erstellen Sie das OLS-Modell
model = sm.OLS(Y, X)
